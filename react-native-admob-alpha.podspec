...
Pod::Spec.new do |s|
  s.name                   = 'react-native-admob-alpha'
  s.version                = version
  s.summary                = 'A react-native component for Google AdMob banners'
  s.homepage               = 'https://github.com/winplaybox/react-native-admob-alpha'
  s.license                = package['license']
  s.author                 = 'Winplaybox <winplaybox@gmail.com>'
  s.platforms              = { :ios => '9.0', :tvos => '9.2' }
  s.source                 = { :git => 'https://github.com/winplaybox/react-native-admob-alpha.git', :tag => "v#{version}" }
