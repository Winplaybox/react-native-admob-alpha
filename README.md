# react-native-admob-alpha [![npm](https://img.shields.io/npm/v/react-native-admob-alpha.svg)](https://www.npmjs.com/package/react-native-admob-alpha)
...
**npm:**
    ...
    npm i --save react-native-admob-alpha

**Yarn:**

    yarn add react-native-admob-alpha
...
Alternatively for iOS you can install the library with CocoaPods by adding a line to your `Podfile`;
    ...
    pod 'react-native-admob-alpha', path: '../node_modules/react-native-admob-alpha'
